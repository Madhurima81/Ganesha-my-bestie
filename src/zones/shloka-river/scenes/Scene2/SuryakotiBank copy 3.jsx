...
const SuryakotiBankContent = ({
  ...
  useEffect(() => {
    ...
    return () => {
      if (window.combinedMemoryGame) {
        delete window.combinedMemoryGame;
      }
    };
  }, []);
  ...
  const startPracticeRound = (word, round) => {
    ...
    if (window.combinedMemoryGame && window.combinedMemoryGame.startPracticeMode) {
      window.combinedMemoryGame.startPracticeMode(word, round);
    }
  ...
  const combinedMemoryGameReloadProps = sceneState.memoryGameState ? {
    isReload: isReload,
                  ...
                  <button
                    onClick={() => {
                      ...
                      setTimeout(() => {
                        ...
                        setTimeout(() => {
                          if (window.combinedMemoryGame?.startSamaprabhaPhase) {
                            window.combinedMemoryGame.startSamaprabhaPhase();
                          }
                        }, 200);

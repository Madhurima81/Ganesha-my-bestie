...
const NirvighnamChantContent = ({
  ...
  useEffect(() => {
    ...
    console.log('🔄 NIRVIGHNAM RELOAD: Starting reload', {
    ...
    if (playAgainRequested === 'true') {
      console.log('🔄 NIRVIGHNAM: Fresh restart after Play Again');
    ...
    switch (sceneState.phase) {
      case PHASES.INITIAL:
        console.log('🔄 NIRVIGHNAM: Resuming initial welcome');
        break;
        
      case PHASES.NIRVIGHNAM_GAME_ACTIVE:
        console.log('🔄 NIRVIGHNAM: Nirvighnam game active - letting component handle itself');
        break;

      case PHASES.KURUMEDEVA_GAME_ACTIVE:
        console.log('🔄 NIRVIGHNAM: Kurumedeva game active - letting component handle itself');
        setNirvighnamPowerGained(true);
        break;
        
      case PHASES.NIRVIGHNAM_COMPLETE:
        console.log('🔄 NIRVIGHNAM: Resuming Nirvighnam completion celebration');
      ...
      case PHASES.KURUMEDEVA_COMPLETE:
        console.log('🔄 NIRVIGHNAM: Resuming Kurumedeva completion celebration');
      ...
      case PHASES.GANESHA_BLESSING_NIRVIGHNAM:
        console.log('🔄 NIRVIGHNAM: Resuming Ganesha blessing for Nirvighnam');
        setBlessingWord('nirvighnam');
        setCurrentPracticeWord('nirvighnam');
      ...
      case PHASES.GANESHA_BLESSING_KURUMEDEVA:
        console.log('🔄 NIRVIGHNAM: Resuming Ganesha blessing for Kurumedeva');
        setBlessingWord('kurumedeva');
        setCurrentPracticeWord('kurumedeva');
        setShowChoiceButtons(false);
        setShowWordCelebration(false);
      ...
      case PHASES.CHOICE_BUTTONS_NIRVIGHNAM:
        console.log('🔄 NIRVIGHNAM: Resuming choice buttons for Nirvighnam');
        setCurrentPracticeWord('nirvighnam');
      ...
      case PHASES.CHOICE_BUTTONS_KURUMEDEVA:
        console.log('🔄 NIRVIGHNAM: Resuming choice buttons for Kurumedeva');
        setCurrentPracticeWord('kurumedeva');
        setShowGaneshaBlessing(false);
        setShowWordCelebration(false);
        setShowRescueMission(false);
      ...
      case PHASES.RESCUE_MISSION_NIRVIGHNAM:
        console.log('🔄 NIRVIGHNAM: Resuming rescue mission for Nirvighnam');
        setCurrentRescueWord('nirvighnam');
        setShowRescueMission(true);
        break;
        
      case PHASES.KURUMEDEVA_STORY:
        console.log('🔄 NIRVIGHNAM: Resuming Kurumedeva story');
        setNirvighnamPowerGained(true);
        setShowKurumedevaStory(true);
        break;
        
      case PHASES.RESCUE_MISSION_KURUMEDEVA:
        console.log('🔄 NIRVIGHNAM: Resuming rescue mission for Kurumedeva');
      ...
      case PHASES.SCENE_COMPLETE:
        console.log('🔄 NIRVIGHNAM: Resuming scene complete');
        if (!sceneState.showingCompletionScreen) {
          setTimeout(() => {
      ...
      default:
        console.log('🔄 NIRVIGHNAM: No specific reload needed for phase:', sceneState.phase);
    }
  }, [isReload]);

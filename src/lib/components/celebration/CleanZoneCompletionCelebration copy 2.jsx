// CleanZoneCompletionCelebration.jsx - Clean Portal + Fireworks + Certificate with Orbital Symbols + Cosmic Sound Waves
...
const CleanZoneCompletionCelebration = ({
  ...
  // Phase timing - Updated for fireworks integration
  const PHASE_DURATIONS = {
    1: 5000,  // Portal + fireworks (extended)
  ...
  useEffect(() => {
    ...
    // Fireworks timing: Start after 1.5s, run for 2.5s
    ...
    // Phase 2: Certificate (after fireworks end)
  ...
  return (
    <div className="clean-zone-completion">
      {/* Phase 1: Clean Portal with Aura Circles, Orbital Symbols, Cosmic Sound Waves + FIREWORKS */}
      {showPortal && (
            ...
            <div className="portal-inner">
              <div className="portal-core">
                <div className="divine-ganesha-silhouette">
                  ...
                  {/* Cosmic Sound Waves around Ganesha */}
      ...
      <style jsx>{`
        ...
        .achievement-certificate {
          ...
          opacity: 0;
          animation: certificateAppear 1s ease-out 5s forwards;
        }
        ...
        .certificate-title {
          ...
          animation: titleShine 2s ease-in-out 6s;
        }
        ...
        .achievement-star {
          ...
          animation: starReveal 0.6s ease-out 6s forwards;
          opacity: 0;
        }
        ...
        .mastered-symbol {
          ...
          opacity: 0;
          animation: symbolFloat 0.8s ease-out 7s forwards;
        }
        ...
        .action-choices {
          ...
          margin-top: 1.5rem;
          opacity: 0;
          animation: buttonsSlideUp 1s ease-out 8s forwards;
        }

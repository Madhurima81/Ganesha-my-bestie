 ...
 * @param {string} props.symbolImage - Path to symbol image to display (NEW)
 * @param {string} props.imageAlt - Alt text for the symbol image (NEW)
...
const Celebration = ({
  ...
  score,
  stars = 0,
  symbolImage, // NEW: Added support for image display
  imageAlt = 'Symbol',  // NEW: Alt text for accessibility
  onContinue,
  onReplay,
  showConfetti = true,
  ...rest
    ...
    <div className="popup-overlay" {...rest}>
      ...
      <div className="popup-container" style={{ textAlign: 'center' }}>
        <div className="popup-content">
          ...
          {/* NEW: Display symbol image if provided */}
          {symbolImage && (

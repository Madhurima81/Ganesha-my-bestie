  ...
  useEffect(() => {
    ...
    if (matchingMessage) {
      ...
      const timer = safeSetTimeout(() => {
        // Show sparkle effect first if configured
        if (onSparkleEffect && matchingMessage.sparkleType) {
          onSparkleEffect(matchingMessage.sparkleType);
          
          safeSetTimeout(() => {
            showActualMessage(matchingMessage);
          }, matchingMessage.sparkleDelay || 2000);
        } else {
          showActualMessage(matchingMessage);
        }
